...
class FulaApiService implements FulaApi {
  ...
  /// Route a download by the object's [sourceBucket]. [sourceBucket] is
  /// retained for call-site compatibility; all content routes to
  /// [downloadObject]. (The former AI-workspace branch was removed.)
  @override
  Future<Uint8List> downloadBySourceBucket(
          String bucket, String key, String? sourceBucket) =>
      downloadObject(bucket, key);

  /// LAN-first sibling of [downloadBySourceBucket].
  @override

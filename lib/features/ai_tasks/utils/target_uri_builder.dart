...
/// Build per-target URIs for the AI automation CRM flow.
///
...
/// target app — these URLs do not auto-send. That's the deliberate compliance
/// posture (WhatsApp ToS, App Store / Play Store policies).

...
/// in image coords (revision H3 in the Dump plan).
class DumpDoodlePainter extends CustomPainter {
  final List<Stroke> strokes;

  const DumpDoodlePainter({required this.strokes});
  ...
  @override
  bool shouldRepaint(covariant DumpDoodlePainter old) {

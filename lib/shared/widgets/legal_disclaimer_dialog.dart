...
/// Pre-run disclaimer for bulk-send tasks (hidden AI + active Automate).
/// The send mechanism uses each target app's documented click-to-chat /
/// mailto / sms URL scheme — the user still taps Send inside the target
/// app for every message. Surface that here so nobody expects auto-send.
///
/// Returns `true` when the user confirms; `false` (or null) otherwise.
Future<bool> showBulkSendDisclaimer(BuildContext context) async {
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _Bullet(
                'All processing runs entirely on this device. No row '
                'data leaves your phone / computer.',

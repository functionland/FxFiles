...
class _WebHomeScreenState extends State<WebHomeScreen> {
  ...
  void _initSignedIn() {
    ...
    // HAND OFF a Blox pairing return captured at startup (web only; the VM
    // stub holder is always empty). Placed HERE for the same reason as the
    // OAuth completion: the user must be signed in before the credentials are
    // persisted against their session. One-shot: `take` clears the holder.

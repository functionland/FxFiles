...
/// is cloud-only, so the native "Phone"/device rows (the only non-bar rows)
/// are omitted and the section is a single **Cloud** progress bar: a 36×36
/// primary-tinted cloud icon, the "Cloud" label with "used / total" bytes, and
/// a thin [LinearProgressIndicator] filled to [StorageInfo.usagePercentage].
class WebStorageSection extends StatelessWidget {
  final StorageInfo info;
  const WebStorageSection({super.key, required this.info});

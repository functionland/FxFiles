// Widget test for DumpAddNoteScreen — verifies Save enable/disable
// logic + tag-picker entry point. The actual save flow touches Hive
// + DumpService + the file system; that integration is covered by
...
GoRouter _router() {
  return GoRouter(
    initialLocation: '/dump/add/note',
    routes: [
      GoRoute(
        path: '/dump/add/note',
        builder: (_, __) => const DumpAddNoteScreen(),
      ),
    ],
  );
}

...
(function() {
    ...
    function wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke___web_sys_11349c134ef163cc___features__gen_MessageEvent__MessageEvent_____(arg0, arg1, arg2) {
        wasm.wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke___web_sys_11349c134ef163cc___features__gen_MessageEvent__MessageEvent_____(arg0, arg1, arg2);
    }

    function wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke_______1_(arg0, arg1) {
        wasm.wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke_______1_(arg0, arg1);
    }

    function wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke______(arg0, arg1) {
        wasm.wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke______(arg0, arg1);
    }

    function wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke___wasm_bindgen_8ee5239f0a1af55c___JsValue_____(arg0, arg1, arg2) {
        wasm.wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke___wasm_bindgen_8ee5239f0a1af55c___JsValue_____(arg0, arg1, arg2);
    }
     ...
     * @param {number} ptr
     */
    function rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStreamingUploadHandle(ptr) {
        wasm.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStreamingUploadHandle(ptr);
    }
    __exports.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStreamingUploadHandle = rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStreamingUploadHandle;
     ...
     * @param {number} ptr
     */
    function rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStreamingUploadHandle(ptr) {
        wasm.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAcceptedShareHandle(ptr);
    }
    __exports.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStreamingUploadHandle = rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStreamingUploadHandle;
     ...
     * @param {any} cancel
     */
    function wire__crate__api__forest__put_flat_with_progress_cancellable(port_, client, bucket, path, data, content_type, progress, cancel) {
        const ptr0 = passStringToWasm0(bucket, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        ...
        var ptr3 = isLikeNone(content_type) ? 0 : passStringToWasm0(content_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len3 = WASM_VECTOR_LEN;
        wasm.wire__crate__api__forest__put_flat_with_progress_cancellable(port_, client, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, progress, cancel);
    }
    __exports.wire__crate__api__forest__put_flat_with_progress_cancellable = wire__crate__api__forest__put_flat_with_progress_cancellable;
     ...
     * @param {string | null} [content_type]
     */
    function wire__crate__api__forest__streaming_upload_begin(port_, client, bucket, key, content_type) {
        const ptr0 = passStringToWasm0(bucket, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        ...
        wasm.wire__crate__api__forest__streaming_upload_begin(port_, client, ptr0, len0, ptr1, len1, ptr2, len2);
    }
    __exports.wire__crate__api__forest__streaming_upload_begin = wire__crate__api__forest__streaming_upload_begin;
     ...
     */
    function wire__crate__api__forest__streaming_upload_chunk(port_, handle, chunk_index, bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.wire__crate__api__forest__streaming_upload_chunk(port_, handle, chunk_index, ptr0, len0);
    }
    __exports.wire__crate__api__forest__streaming_upload_chunk = wire__crate__api__forest__streaming_upload_chunk;

    /**
     * @param {any} port_
     * @param {any} handle
     */
    function wire__crate__api__forest__streaming_upload_finalize_plan(port_, handle) {
        wasm.wire__crate__api__forest__streaming_upload_finalize_plan(port_, handle);
    }
    __exports.wire__crate__api__forest__streaming_upload_finalize_plan = wire__crate__api__forest__streaming_upload_finalize_plan;

    /**
     * @param {any} port_
     * @param {any} handle
     */
    function wire__crate__api__forest__streaming_upload_finish(port_, handle) {
        wasm.wire__crate__api__forest__streaming_upload_finish(port_, handle);
    }
    __exports.wire__crate__api__forest__streaming_upload_finish = wire__crate__api__forest__streaming_upload_finish;
     ...
     * @param {Uint8Array} bytes
     */
    function wire__crate__api__forest__streaming_upload_plan_chunk(port_, handle, bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.wire__crate__api__forest__streaming_upload_plan_chunk(port_, handle, ptr0, len0);
    }
    __exports.wire__crate__api__forest__streaming_upload_plan_chunk = wire__crate__api__forest__streaming_upload_plan_chunk;
     ...
     * @param {Uint8Array} recipient_public_key
     * @param {string | null | undefined} path_scope
     * @param {any} expires_in_seconds
     */
    function wire__crate__api__sharing__wrap_secret_for_recipient(port_, secret, recipient_public_key, path_scope, expires_in_seconds) {
        const ptr0 = passArray8ToWasm0(secret, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(recipient_public_key, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(path_scope) ? 0 : passStringToWasm0(path_scope, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        wasm.wire__crate__api__sharing__wrap_secret_for_recipient(port_, ptr0, len0, ptr1, len1, ptr2, len2, expires_in_seconds);
    }
    __exports.wire__crate__api__sharing__wrap_secret_for_recipient = wire__crate__api__sharing__wrap_secret_for_recipient;
    ...
    function __wbg_get_imports() {
        ...
        imports.wbg.__wbindgen_cast_0001c4515e512a9f = function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen_8ee5239f0a1af55c___closure__destroy___dyn_core_f0fd674eaa06beef___ops__function__FnMut__web_sys_11349c134ef163cc___features__gen_MessageEvent__MessageEvent____Output_______, wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke___web_sys_11349c134ef163cc___features__gen_MessageEvent__MessageEvent_____);
            return ret;
        };
        imports.wbg.__wbindgen_cast_192940846b2c09af = function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 521, function: Function { arguments: [NamedExternref("MessageEvent")], shim_idx: 522, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen_8ee5239f0a1af55c___closure__destroy___dyn_core_f0fd674eaa06beef___ops__function__FnMut__web_sys_11349c134ef163cc___features__gen_MessageEvent__MessageEvent____Output_______, wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke___web_sys_11349c134ef163cc___features__gen_MessageEvent__MessageEvent_____);
            return ret;
        };
        ...
        imports.wbg.__wbindgen_cast_40758286b4b4892f = function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 812, function: Function { arguments: [Externref], shim_idx: 813, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen_8ee5239f0a1af55c___closure__destroy___dyn_core_f0fd674eaa06beef___ops__function__FnMut__wasm_bindgen_8ee5239f0a1af55c___JsValue____Output_______, wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke___wasm_bindgen_8ee5239f0a1af55c___JsValue_____);
            return ret;
        };
        ...
        imports.wbg.__wbindgen_cast_4b04e6eb79644a86 = function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen_8ee5239f0a1af55c___closure__destroy___dyn_core_f0fd674eaa06beef___ops__function__FnMut_____Output________1_, wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke_______1_);
            return ret;
        };
        imports.wbg.__wbindgen_cast_6b1b481ec5d6dc1d = function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen_8ee5239f0a1af55c___closure__destroy___dyn_core_f0fd674eaa06beef___ops__function__FnMut_____Output_______, wasm_bindgen_8ee5239f0a1af55c___convert__closures_____invoke______);
            return ret;
        };
